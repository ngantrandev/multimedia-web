...
<body>
	...
	<div id="container-header">
		<h2 style="margin-left:24px" id="label-header">Thêm sự kiện</h2>
	</div>
	<form:form class="web-form-container" action="/multimedia_web/event/create.htm"
		method="POST" enctype="multipart/form-data" modelAttribute="event">
	  <div class="form-group">
	    <label class="label-input">Tên sự kiện</label>
	    <form:input path="name" type="text" class="form-control web-input-title" placeholder="Nhập tiêu đề"/>
	  </div>
	  <div class="form-group">
