...
<body style="background-color:#FFFF" class="d-flex flex-column">
    <div id="body" class=".container d-flex flex-column mb-5" style="height: fit-content;" >
	    ...
	    <form id="formlogin" class="d-flex flex-column" action="/multimedia_web/password/resetPass.htm" method="post">
	        <div id="bodycontainer_body" class="p-1 p-lg-4">
	            <div class="inputgroup d-flex flex-column">
	               <label for="lgMSSV" class="p-2">Mật khẩu mới</label>
	               <input type="password" id="lgMSSV" name="newPw" class="col-10 p-2" placeholder="Nhập mật khẩu mới" style="border-radius:10px;border-color:#F6911D;"/>
	            </div>
	            <div class="inputgroup d-flex flex-column">
	               <label class="p-2">Xác nhận mật khẩu mới</label>
	               <input type="password" name="confirmNewPw" class="col-10 p-2" placeholder="Xác nhận mật khẩu mới" style="border-radius:10px;border-color:#F6911D;"/>
	            </div>
	    	</div>
	    	<div style="color:red">
	    		${message}
		    ...
		    <div id="bodycontainer_footer" class="d-flex p-3" >
		        <button class="col-4 p-2 btn" id="btn_submit"  type="submit">Đổi mật khẩu</button>
		    </div>
	    </form>
   </div>
</body>
