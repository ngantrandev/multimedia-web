...
<body style="background-color:#FFFF" class="d-flex flex-column">
    <div id="body" class=".container d-flex flex-column mb-5" style="height: fit-content;" >
	    ...
	    <form id="formlogin" class="d-flex flex-column" action="/multimedia_web/password/sendOtp.htm" method="post">
	        <div id="bodycontainer_body" class="p-1 p-lg-4">
	            <div class="inputgroup d-flex flex-column">
	               ...
	               <input id="lgMSSV" name="mssv" class="col-10 p-2" placeholder="Nhập mã sinh viên" style="border-radius:10px;border-color:#F6911D;"/>
	            </div>
	    	</div>
		    <div id="bodycontainer_footer" class="d-flex p-3" >
		        <button class="col-4 p-2 btn" id="btn_submit"  type="submit">Gửi otp</button>
		    </div>
	    </form>
   </div>
</body>
